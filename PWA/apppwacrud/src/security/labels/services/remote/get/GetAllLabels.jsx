...
//AGU: URL = http://localhost:3000/api/v1/etiquetas
//AGU: axios.get("http://localhost:3000/api/v1/etiquetas")
axios.get(import.meta.env.VITE_CAT_ETIQUETAS_URL)
.then((response) => {
const data = response.data;
//console.log("getAllLabels()", data);
if (!data.success) {
reject(data); //CAR: Rechaza la promesa con la respuesta si no fue exitosa
